...
class Confirm(discord.ui.View):
    ...
    failure_messages = ["БУМ и ты отлетаешь!", "**YOU DIED**", "Пока-пока!)", "Да ты снайпер! Точно в цель)", "Ну, в любви уже не повезёт", "Удачный косплей на Кобейна", "Упс, в барабане оказалось больше патронов"] ## Сообщения при выстреле
